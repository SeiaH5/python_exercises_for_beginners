# Python Programming Practice Sets
...
**Prog09:** `capitalize()` makes the first letter of the string capital letter and all other letters small case. Create a program that do the same functionality without using `capitalize()` function.

**Prog10:** `title()` makes all first letters of each word in the string capital letter and all other letters small case. Create a program that do the same functionality without using `title()` function.
